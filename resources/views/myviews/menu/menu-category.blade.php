      ...
      <div class="container">
        ...
        <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <form action="{{route('menu-add-category')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="card-body">
                    <div>
                      <label for="defaultFormControlInput" class="form-label">Kategori Adi</label>
                      <input type="text"
                             class="form-control"
                             name="title"
                             id="title"
              ...
              <table class="table table-striped">
                ...
                @foreach($category as $rs)
                  <tr>
                    ...
                    <td>{{$rs->created_at}}</td>
                    <td>
                      <form action="{{ route('menu-delete-category', $rs->id) }}" method="POST">
                        @csrf
                        @method('POST')
